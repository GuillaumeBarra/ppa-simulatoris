...
public class Fox extends Animal
{
    ...
    private static double huntingProbability = 0.5;
    // The probability change of a fox catching a prey successfully.
    private static final double HUNTING_PROBABILITY_CHANGE = 0.3;
     ...
     */
    public void act(List<Animal> newFoxes, boolean isNight)
    {
        incrementAge();
        incrementHunger();
        if(isAlive()) {
            if (!isNight) {
                System.out.println("Not night, not asleep");
                isAsleep = false;
            }
            if (isAsleep) {
                System.out.println("first asleep!");
                return;
            }
            else {
                if(isNight){
                    ...
                    if (isAsleep) {
                        System.out.println("Second asleep!");
                        return;
                    }
     ...
     * @param newFoxes A list to return newly born foxes.
     */
    public void breed(List<Animal> newFoxes)
    {
